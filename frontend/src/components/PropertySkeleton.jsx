...
export function PropertyCardSkeleton() {
  return (
    <div className="bg-white border border-brand-sandDark rounded-2xl overflow-hidden shadow-sm flex flex-col justify-between animate-pulse">
      <div>
        {/* Aspect Ratio Header Visual Placeholder */}
...
export function PropertiesGridSkeleton({ count = 4 }) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6" aria-label="Loading listings catalog">
