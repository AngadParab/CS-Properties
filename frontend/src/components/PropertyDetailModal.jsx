  ...
  useEffect(() => {
    ...
    return () => {
      ...
      if (currentModal?._handleKeyDown) {
        window.removeEventListener('keydown', currentModal._handleKeyDown);
      }
      if (previousActiveElement && previousActiveElement.focus) {
        previousActiveElement.focus();
      }
    };
  }, [activeModalProperty, setActiveModalProperty]);
  ...
  return (
    <AnimatePresence>
      <div 
        ...
        aria-describedby="modal-property-desc"
      >
        {/* Backdrop overlay */}
        <motion.div
          initial={{ opacity: 0 }}
        ...
        >
          ...
          <div className={`h-56 bg-gradient-to-br ${gradientClass} relative p-8 flex flex-col justify-between text-white`}>
            ...
            <div className="space-y-1">
              <h2 id="modal-property-title" className="text-2xl font-bold tracking-tight text-white drop-shadow">
                {propertyTitle}
              </h2>
          ...
          <div id="modal-property-desc" className="p-8 space-y-6 flex-grow overflow-y-auto max-h-[60vh]">
